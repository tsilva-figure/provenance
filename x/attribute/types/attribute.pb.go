...
// CreateRootAttributeProposal details a proposal to create a new attribute
// that is controlled by a given owner
type CreateAttributeProposal struct {
...
func (m *CreateAttributeProposal) Reset()      { *m = CreateAttributeProposal{} }
func (*CreateAttributeProposal) ProtoMessage() {}
func (*CreateAttributeProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_14fe7eb43c711f5e, []int{2}
}
func (m *CreateAttributeProposal) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CreateAttributeProposal) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CreateAttributeProposal.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CreateAttributeProposal) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CreateAttributeProposal.Merge(m, src)
}
func (m *CreateAttributeProposal) XXX_Size() int {
	return m.Size()
}
func (m *CreateAttributeProposal) XXX_DiscardUnknown() {
	xxx_messageInfo_CreateAttributeProposal.DiscardUnknown(m)
}

var xxx_messageInfo_CreateAttributeProposal proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*CreateAttributeProposal)(nil), "provenance.attribute.v1.CreateAttributeProposal")
}
...
var fileDescriptor_14fe7eb43c711f5e = []byte{
	...
	,
}
...
func (m *CreateAttributeProposal) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CreateAttributeProposal) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CreateAttributeProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Description) > 0 {
		...
		i = encodeVarintAttribute(dAtA, i, uint64(len(m.Description)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Title) > 0 {
		i -= len(m.Title)
		copy(dAtA[i:], m.Title)
		i = encodeVarintAttribute(dAtA, i, uint64(len(m.Title)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *CreateAttributeProposal) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CreateAttributeProposal) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CreateAttributeProposal: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CreateAttributeProposal: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
